...
# enemy
monster_data = {
	'monster lvl 1': {'health': 100,'exp':100,'damage':(10, 20),'image': '../graphics/monsters/monster lvl 1/monster lvl 1 solo.png', 'attack_type': 'slash', 'music': '../audio/battle-music.mp3', 'background_image': '../graphics/img/forest.jpeg', 'attack_sound':'../audio/attack/slash.wav', 'speed': 3, 'resistance': 3, 'attack_radius': 30, 'notice_radius': 30},
	'monster lvl 2': {'health': 300,'exp':250,'damage':(20, 30),'image': '../graphics/monsters/monster lvl 2/monster lvl 2 solo.png','attack_type': 'claw','music': '../audio/battle-music.mp3', 'background_image': '../graphics/img/forest.jpeg','attack_sound':'../audio/attack/claw.wav','speed': 2, 'resistance': 3, 'attack_radius': 1, 'notice_radius': 1},
	'boss': {'health': 900,'exp':110,'damage':(50, 70),'image': '../graphics/monsters/boss/final boss.png','attack_type': 'thunder', 'music': '../audio/boss theme.mp3', 'background_image': '../graphics/img/desert.jpeg', 'attack_sound':'../audio/attack/fireball.wav', 'speed': 4, 'resistance': 3, 'attack_radius': 30, 'notice_radius': 30},
	'monster lvl 3': {'health': 700,'exp':120,'damage':(30, 50),'image': '../graphics/monsters/monster lvl 3/monster lvl 3 solo.png','attack_type': 'leaf_attack', 'music': '../audio/battle-music.mp3', 'background_image': '../graphics/img/forest.jpeg', 'attack_sound':'../audio/attack/slash.wav', 'speed': 3, 'resistance': 3, 'attack_radius': 30, 'notice_radius': 30}
    }
